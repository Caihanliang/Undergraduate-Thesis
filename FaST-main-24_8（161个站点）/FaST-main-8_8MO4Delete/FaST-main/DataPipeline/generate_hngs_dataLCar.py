...
def load_and_preprocess_data(input_file, output_dir='HNGS_NLC'):
    """
    加载并预处理原始数据
...
def generate_meta_data(station_names, output_dir='HNGS_NLC'):
    """
    生成站点元数据
...
def generate_adjacency_matrix(num_nodes, method='distance', meta_df=None, output_dir='HNGS_NLC'):
    """
    生成邻接矩阵
...
if __name__ == "__main__":
    ...
    # ========== 第一步：加载和预处理数据 ==========
    # 请修改为你的原始数据文件路径
    input_file = "NLittleCar真正名9_10.csv"  # 或 "hunan_highway_traffic_test.xlsx"
    
    try:
        df, station_names = load_and_preprocess_data(input_file, output_dir='HNGS_NLC')
    ...
    # ========== 第二步：生成元数据 ==========
    meta_df = generate_meta_data(station_names, output_dir='HNGS_NLC')
    ...
    # FaST-main-24_8/FaST-main/DataPipeline/generate_hngs_dataLCar.py
    # python DataPipeline/generate_hngs_dataLCar.py