# # 自动归一化、能解决你所有问题的版本！   这里将输入的数据进行归一化处理
# import os
# import argparse
# import numpy as np
# import pandas as pd
...
#     for y in years:
#         # 从 HNGS_512 子目录读取数据文件
#         # df_tmp = pd.read_hdf(f"HNGS_512/hngs_his_{y}_512.h5")
...
#     out_dir = "../main-master/datasets/HNGS_512/" 
...
if __name__ == "__main__":
    ...
    # python DataPipeline/generate_hngs_training_data_512.py
