...
def loadData(args):
    ...
    df = pd.read_csv('/home/user/FSTLLM/contrast/Traffic-Benchmark-master/methods/GMAN/METR/data/subway/subway.csv', header=0, index_col=0)
    ...
    # 逻辑：(当前总分钟数 - 起始点6:00的总分钟数) // 15
    # 6:00 对应分钟数是 6 * 60 = 360
    timeofday = (Time.hour * 60 + Time.minute - 360) // 15
