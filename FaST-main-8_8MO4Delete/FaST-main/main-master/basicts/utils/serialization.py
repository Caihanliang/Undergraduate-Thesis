...
def load_dataset_desc(dataset_name: str) -> str:
    ...
    # read json file: datasets/dataset_name/desc.json
    with open(f'/home/user/Downloads/cai/FaST-main-8_8MO/FaST-main/main-master/datasets/{dataset_name}/desc.json', 'r') as f:
    # with open(f'main-master/datasets/{dataset_name}/desc.json', 'r') as f:  #/home/user/Downloads/cai/FaST-main-24_8/FaST-main/main-master/datasets/{dataset_name}/desc.json
