...
############################## Validation Configuration验证 & 测试配置 ##############################
CFG.VAL = EasyDict()
CFG.VAL.INTERVAL = 1    # 每轮训练完都验证
...
############################## Test Configuration ##############################
CFG.TEST = EasyDict()
CFG.TEST.INTERVAL = 200   # 每200轮测试一次
